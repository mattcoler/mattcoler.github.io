...
The curriculum is aligned across four blocks. The first block is called **Background**. The courses in this block lay the foundations for the MSc. Voice Technology with essential content needed for the rest of the program, such as skills in programming and speech sounds analysis. The Introduction to Voice Technology course provides the basic elements of speech recogni=on and synthesis and introduces topics relating to data management, privacy issues and the interaction between humans and voice tech applications.
